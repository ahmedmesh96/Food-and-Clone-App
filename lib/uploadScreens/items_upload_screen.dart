...
class _ItmesUploadScreenState extends State<ItmesUploadScreen> {
  ...
  validateUploadForm() async {
    ...
    if(imageXFile != null)
    {
      if(shortInfoController.text.isNotEmpty && titleController.text.isNotEmpty && descritionController.text.isNotEmpty&& priceController.text.isNotEmpty)
      {
  ...
  saveInfo(String downloadUrl)
  {
    ...
    ref.doc(uniqueIdName).set({
      ...
      "descriptionInfo": descritionController.text.toString(),
      "priceInfo": int.parse(priceController.text),
      "title": titleController.text.toString(),
      "punlishedDate": DateTime.now(),
      "status": "availavle",
      "thumbanilUrl": downloadUrl,
  ...
  Widget build(BuildContext context) {
    return imageXFile == null ? defaultScreen() : ItmesUploadScreen();
  }
}
